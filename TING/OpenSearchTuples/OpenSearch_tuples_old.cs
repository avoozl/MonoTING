...
namespace LINQAndTuplesTest
{
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			XElement xe_raw = XElement.Load (@"http://opensearch.addi.dk/next_2.2/?action=search&query=hansen&start=1&stepValue=2&outputType=xml&profile=test&agency=100200");
